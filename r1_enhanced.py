...
# Ensure the DataFrame has both 'r1_enhanced_protocol' and 'r1_enhanced_reasoning' columns
if "r1_enhanced_protocol" not in cases.columns:
    cases["r1_enhanced_protocol"] = pd.NA
if "r1_enhanced_reasoning" not in cases.columns:
    cases["r1_enhanced_reasoning"] = pd.NA

cases["r1_enhanced_protocol"] = cases["r1_enhanced_protocol"].astype("object")
cases["r1_enhanced_reasoning"] = cases["r1_enhanced_reasoning"].astype("object")
...
for i in range(0, len(cases)):
    ...
    cases.at[i, "r1_enhanced_protocol"] = json_str
    cases.at[i, "r1_enhanced_reasoning"] = reasoning

    # Print outputs for verification
    print(f"Case {i} Protocol:", cases.at[i, "r1_enhanced_protocol"])
    print(f"Case {i} Reasoning:", cases.at[i, "r1_enhanced_reasoning"])
