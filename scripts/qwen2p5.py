...
# Ensure the DataFrame has both 'qwen2p5_base_protocol' and 'qwen2p5_base_reasoning' columns
if "qwen2p5_base_protocol" not in cases.columns:
    cases["qwen2p5_base_protocol"] = pd.NA
if "qwen2p5_base_reasoning" not in cases.columns:
    cases["qwen2p5_base_reasoning"] = pd.NA

cases["qwen2p5_base_protocol"] = cases["qwen2p5_base_protocol"].astype("object")
cases["qwen2p5_base_reasoning"] = cases["qwen2p5_base_reasoning"].astype("object")
...
for i in range(0, len(cases)):
    ...
    cases.at[i, "qwen2p5_base_reasoning"] = reasoning
    cases.at[i, "qwen2p5_base_protocol"] = json.dumps(output_dict)

    # Print outputs for verification
    print("Protocol:", cases.at[i, "qwen2p5_base_protocol"])
    print("Reasoning:", cases.at[i, "qwen2p5_base_reasoning"])
