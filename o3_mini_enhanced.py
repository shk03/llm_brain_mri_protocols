...
if "o3_mini_enhanced_protocol" not in cases.columns:
    cases["o3_mini_enhanced_protocol"] = pd.NA
if "o3_mini_enhanced_reasoning" not in cases.columns:
    cases["o3_mini_enhanced_reasoning"] = pd.NA
...
for i in range(0, len(cases)):
    ...
    cases.at[i, "o3_mini_enhanced_reasoning"] = reasoning
    cases.at[i, "o3_mini_enhanced_protocol"] = json.dumps(output_dict)

    # Print outputs for verification
    print(f"Case {i} Protocol:", cases.at[i, "o3_mini_enhanced_protocol"])
    print(f"Case {i} Reasoning:", cases.at[i, "o3_mini_enhanced_reasoning"])
