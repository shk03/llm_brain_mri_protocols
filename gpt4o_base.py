...
if "gpt4o_base_protocol" not in cases.columns:
    cases["gpt4o_base_protocol"] = pd.NA
if "gpt4o_base_reasoning" not in cases.columns:
    cases["gpt4o_base_reasoning"] = pd.NA
...
for i in range(0, 1):
    ...
    cases.at[i, "gpt4o_base_reasoning"] = reasoning
    cases.at[i, "gpt4o_base_protocol"] = json.dumps(output_dict)

    # Print outputs for verification
    print("Protocol:", cases.at[i, "gpt4o_base_protocol"])
    print("Reasoning:", cases.at[i, "gpt4o_base_reasoning"])
